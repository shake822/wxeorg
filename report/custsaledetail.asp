...
<%
sql_power = "select * from t_power where code='0212' and user='"&request.cookies("username")&"'"
...
%>
<form id="form1" name="sample" method="post" action="custsaledetail.asp">
  <table width="100%" border="0" id="tbl_tittle">
    <tr>
      ...
      <td width="33%" rowspan="3"><input type="submit" name="Submit" value=" 查 询 " /></td>
    </tr>
    <tr>
      <td height="26">从日期</td>
      <td><label>
...
<div align="center"><span class="style1">销售明细表</span></div>
<%
