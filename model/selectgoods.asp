...
<tr>
  ...
  <td id="td"><input type="button" value="新增货品"  class="button" onClick="window.location.href='../common/addgoods.asp?add=true&sel=true'" class="button"></td>
</tr>
</form>
</table>
<hr>
...
if Request.Form("s_goodsname") = "" then
  ...
  s_goodsname = " and goodsname='"&request("s_goodsname")&"'"
end if 
...
Call showpage(sql,"SelectGoods1",6)
endconnection
%>
</body>
</html>
