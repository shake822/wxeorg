...
{
	return("<table width='100%' cellspacing='0' cellpadding='2' border='0'><tr valign=middle  onMouseOver='onColor(this);' onMouseOut='offColor(this);'><td align='left' class='grayLine2'>&nbsp;<img src='../img/menu_dot.jpg'>&nbsp;<a href='"+id+"'>"+name+"</a></td></tr></table>")
	...
	if (number!=-1)
		{
			if (i==-1)
				...
				document.all("outlooktitle"+i).style.backgroundImage="url(../img/listbar.jpg)";
			...
			document.all("outlooktitle"+number).style.backgroundImage="url(../img/listbar.jpg)";
	...
	for (i=0;i<(outlookbar.titlelist.length);i++)
		{
			...
			if (i!=outlookbar.opentitle) 
				outline+=" align=center class='header' style='cursor:hand;background-color:#89C1E4;color:#fff;height:32;border:0 outset; background-Image:url(../img/listbar.jpg)' ";
			else
				outline+=" align=center class='header' style='cursor:hand;background-color:#3399FF;color:#fff;height:32;border:0 outset; background-Image:url(../img/listbar.jpg)' ";
