...
function postadd()
{
  if (document.getElementById("name").value==""){
    ...
    window.location='../action/saveout.asp?add=true&name='+document.getElementById("name").value;
  }
}
function postdel()
{
  if (document.getElementById("id").value==""){
    ...
    window.location='../action/delout.asp?id='+document.getElementById("id").value;
  }
}
function postedit()
{
...
<body>
<br>
<div align="center"><span class="style1">出库类型</span></div>
...
<tr valign="top"><td><table cellpadding="5" id="tbl">
  ...
  <%
sql = "select * from Dict_out order by id"
...
<td>
<form name="units" method="post" onSubmit="return postedit();" action="../action/saveout.asp?add=false">
<table border="0" align="center">
